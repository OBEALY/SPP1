...
## Что вы сделали (история работы)
1. Сформулировали требования к собственному средству автоматизации тестирования.
2. Реализовали в проекте все ключевые функции: атрибуты, проверки, ошибки, lifecycle, async, shared context, раннер.
3. Добавили демонстрационные тесты, показывающие все возможности.
4. Создали новый репозиторий на GitHub: `https://github.com/OBEALY/SPP1`.
5. Загрузили проект в ветку `main`.

## Текущий статус
Проект готов как учебный пример собственного тестового фреймворка и может использоваться как база для расширения (например: фильтрация тестов, отчёт в JSON/HTML, параллельный запуск).
